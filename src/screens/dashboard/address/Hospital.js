...
const MapWithMarkersAndList = ({navigation}) => {
  ...
  const getQuestions = async () => {
    const url = API.GET_GEOLOCATION + true;
    ...
    <View style={styles.container}>
      {selectedAddress && (
        <View style={styles.mansaContainer}>
          ...
          <View style={[st.wdh70, st.row]}>
            <View style={st.tringle} />
            <View style={styles.mansaContent}>
              <Text style={[st.tx14, st.txAlignL]}>{t('MankakshMansa')}</Text>
            </View>
          </View>
        </View>
      )}
...
export default MapWithMarkersAndList;
